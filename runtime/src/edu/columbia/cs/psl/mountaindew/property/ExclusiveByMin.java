...
public class ExclusiveByMin extends ClusiveAbstract{
...
//			System.out.println("ExclusiveByMin rt2Max, rt2Min, rt2Sum " + rt2Max + " " + rt2Min + " " + rt2Sum);
		...
		if (Number.class.isAssignableFrom(returnValue1.getClass()) && Number.class.isAssignableFrom(returnValue2.getClass())) {
			...
			//The same with inclusive, if the method is going to select min, this cannot work
			if (rt1 >= rt2)
				return true;
		}
		return false;
