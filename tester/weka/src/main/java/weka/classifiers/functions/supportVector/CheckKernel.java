...
public class CheckKernel
  ...
  public Kernel m_Kernel = new weka.classifiers.functions.supportVector.RBFKernel();
   ...
   */
  public void testsPerClassType(int classType, 
                                   boolean weighted,
   ...
   *         was acceptable
   */
  public boolean[] canHandleNClasses(
      boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor, 
      boolean datePredictor,
   ...
   */
  public boolean[] canHandleClassAsNthAttribute(
      boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor, 
      boolean datePredictor,
   ...
   *         was acceptable
   */
  public boolean[] canHandleZeroTraining(
      boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor, 
      boolean datePredictor,
   ...
   */
  public boolean[] correctBuildInitialisation(
      boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor, 
      boolean datePredictor,
   ...
   *         was acceptable
   */
  public boolean[] canHandleMissing(
      boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor, 
      boolean datePredictor,
   ...
   */
  public boolean[] instanceWeights(
      boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor, 
      boolean datePredictor,
   ...
   * @return index 0 is true if the test was passed
   */
  public boolean[] datasetIntegrity(
      boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor, 
      boolean datePredictor,
   ...
   *         was acceptable
   */
  public boolean[] runBasicTest(boolean nominalPredictor,
      boolean numericPredictor, 
      boolean stringPredictor,
      boolean datePredictor,
      boolean relationalPredictor,
   ...
   */
  public Instances makeTestDataset(int seed, int numInstances, 
   ...
   * @param classType the class type (NUMERIC, NOMINAL, etc.)
   */
  public void printAttributeSummary(boolean nominalPredictor, 
                                       boolean numericPredictor, 
                                       boolean stringPredictor, 
                                       boolean datePredictor, 
                                       boolean relationalPredictor, 
